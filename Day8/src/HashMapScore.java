...
public class HashMapScore {
    HashMap<String, StudentScoreHasA> map = new HashMap<>();
    ...
    public void output() {
        for (Map.Entry<String, StudentScoreHasA> entry : map.entrySet()) {
    ...
    public void modify() {
        ...
        if (map.containsKey(name)) {
            StudentScoreHasA stu = map.get(name);
    ...
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        HashMapScore o = new HashMapScore();
        boolean run = true;
        while (run) {
